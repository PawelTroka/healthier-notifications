...
| [Outlook notification controls](https://support.microsoft.com/en-US/Outlook/how-can-i-turn-push-notifications-and-sounds-on-or-off) | Follow-up reference reviewed 2026-09-18: per-account mail notification choices and separate Calendar controls. These are not filters for individual build/PR event types. |
| [Azure DevOps personal subscriptions](https://learn.microsoft.com/en-us/azure/devops/organizations/notifications/manage-your-personal-notifications?view=azure-devops) | Follow-up reference reviewed 2026-09-18: review personal subscriptions and opt out of shared subscriptions for the current user. No subscription changes are made by this toolkit. |
| [Azure DevOps supported event fields](https://learn.microsoft.com/en-us/azure/devops/organizations/notifications/oob-supported-event-types?view=azure-devops) | Follow-up reference reviewed 2026-09-18: event-specific build and PR filter fields. Available choices depend on the selected template; do not assume a universal ownership filter. |
